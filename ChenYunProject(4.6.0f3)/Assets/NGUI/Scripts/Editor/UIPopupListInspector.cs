...
public class UIPopupListInspector : UIWidgetContainerEditor
{
	...
	void OnContentBackground (string spriteName)
	{
		RegisterUndo();
		mList.contentBackgroundSprite = spriteName;
		Repaint();
	}
	...
	void DrawAtlas()
	{
		if (NGUIEditorTools.DrawHeader("Atlas"))
		{
			...
			NGUIEditorTools.DrawPaddedSpriteField("ContentBackground", mList.atlas, mList.contentBackgroundSprite, OnContentBackground);
